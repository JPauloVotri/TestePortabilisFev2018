...
function getbd() {
	$bd = pg_connect("host=localhost port=5432 dbname=votricrum user=postgres password=postgres") or die('connection failed');
	return $bd;
}
...
$result = pg_query(getbd(), "INSERT INTO aluno (nome, telefone, datanasc, cpf, rg) VALUES ('".$nome."', '".$fone."', '".$nasc."', ".$cpf.", '".$rg."')");
